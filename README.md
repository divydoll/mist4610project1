...
#The purpose of this query is to provide a detailed breakdown of each player’s performance in different leagues, specifically focusing on their average goals scored per match and average pass percentage. 
...
#The purpose of this query is to retrieve the players with the highest number of tackles from each team, along with their first name, last name, and team name. 
...
#The purpose of this query is to retrieve detailed information about the player Lionel Messi, including his first name, last name, team name, and position. 
...
#The purpose of this query is to calculate the total number of goals scored by Lionel Messi. 
...
#The purpose of this query is to provide an overview of player performance based on nationality. It shows the number of players and the total number of goals scored by players from each nationality.
